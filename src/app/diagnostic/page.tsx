...
const DataProcessingDiagnostic = ({ scenario }: { scenario: MockScenario }) => {
...
const NetworkStructureDiagnostic = ({ diagnosticData }: { diagnosticData: DiagnosticData | null }) => {
...
const PhysicsDiagnostic = ({ diagnosticData }: { diagnosticData: DiagnosticData | null }) => {
    if (!diagnosticData) return null;
...
const WalletCategorizationDiagnostic = ({ diagnosticData }: { diagnosticData: DiagnosticData | null }) => {
    if (!diagnosticData) return null;
...
const VisualConfigurationDiagnostic = ({ diagnosticData }: { diagnosticData: DiagnosticData | null }) => {
    if (!diagnosticData) return null;
    return (
        <Card>
            <CardHeader>
...
const PerformanceAnalysisDiagnostic = ({ diagnosticData }: { diagnosticData: DiagnosticData | null }) => {
    if (!diagnosticData) return null;
